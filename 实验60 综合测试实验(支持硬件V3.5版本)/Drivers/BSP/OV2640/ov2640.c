...
uint8_t ov2640_init(void)
{
    ...
    sys_gpio_set(OV_PWDN_GPIO_PORT, OV_PWDN_GPIO_PIN, SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID,
                 SYS_GPIO_PUPD_PU); /* PWDN引脚模式设置,推挽输出 */

    sys_gpio_set(OV_RESET_GPIO_PORT, OV_RESET_GPIO_PIN, SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID,
                 SYS_GPIO_PUPD_PU); /* RESET引脚模式设置,推挽输出 */
