...
REINIT: /* 重新初始化 */
    ...
    /* QMA6100P检测 */
    lcd_show_string(5, ypos + fsize * j, lcddev.width, lcddev.height, fsize, "QMA6100P Check...", g_point_color);

    if (qma6100p_init())system_error_show(5, ypos + fsize * (j + 1), "QMA6100P Error!", fsize); /* QMA6100P检测 */
    else lcd_show_string(5 + okoffset, ypos + fsize * j++, lcddev.width, lcddev.height, fsize, "OK", g_point_color);
