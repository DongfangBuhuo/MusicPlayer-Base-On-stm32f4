...
uint8_t ES8388_Init(I2C_HandleTypeDef *hi2c)
{
	...
	ES8388_Write_Reg(0x04, 0x0C); // 只使能LOUT1/ROUT1 (耳机)，禁用LOUT2/ROUT2 (喇叭)
...
void ES8388_SetVolume(uint8_t volume)
{
    ...
    // 我们可以直接映射
    ES8388_Write_Reg(ES8388_DACCONTROL16, volume); // LOUT1
    ES8388_Write_Reg(ES8388_DACCONTROL17, volume); // ROUT1
